...
const container = document.getElementById("cars-container") as HTMLDivElement;

async function fetchCars() {
  try {
    const res = await fetch("https://6821ba35259dad2655b061f7.mockapi.io/Cars");
...
const container1  = document.getElementById("cars-allcontainer") as HTMLDivElement;



async function fetching() {
    try{
        const rers = await fetch("https://6821ba35259dad2655b061f7.mockapi.io/All-cars");
        const datas: Cars[] = await rers.json();
        renderCarss(datas);
    }catch (error) {
    console.error("Xatolik yuz berdi:", error);
  }
...
function renderCarss(cari: Cars[]){
